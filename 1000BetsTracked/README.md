...
- **Snapshot pulled:** 2026-06-04
- **Placement span:** 2026-04-25 → 2026-06-04
- **Sports:** Baseball 423, Soccer 307, Basketball 123, Hockey 86, Cricket 1
...
|------|---------|--------------|------------|
| `paper_trades.jsonl` | 940 | a placement | `placed_at`, `book`, `market_id`, `side`, `selection`, `fair_prob`, `avg_fill_price`, `shares`, `stake`, `edge_pct`, `kelly_fraction_applied`, `bankroll_at_placement`, `levels` |
| `paper_closes.jsonl` | 935 | a closing-line capture | `captured_at`, `market_id`, `side`, `fair_prob_close`, `yes_side_price_close`, `minutes_before_start` |
| `paper_settlements.jsonl` | 930 | a settled bet (outcome) | `settled_at`, `market_id`, `side`, `result`, `net_pnl`, `gross_return`, `fair_prob`, `fair_prob_close`, `clv`, `stake`, `pin_sport`, `market_type` |
